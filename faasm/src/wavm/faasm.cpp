...
static void __faasm_write_output(
  WAVM::Runtime::ContextRuntimeData* contextRuntimeData,
  I32 outputPtr,
  I32 outputLen);
static WAVM::Intrinsics::Function __faasm_write_outputIntrinsic(
  getIntrinsicModule_env(),
  "__faasm_write_output",
  (void*)&__faasm_write_output,
  WAVM::Intrinsics::inferIntrinsicFunctionType(&__faasm_write_output));
static void __faasm_write_output(
  WAVM::Runtime::ContextRuntimeData* contextRuntimeData,
  I32 outputPtr,
  I32 outputLen)
